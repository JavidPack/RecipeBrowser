...
namespace RecipeBrowser.UI
{
	...
	{
		static Texture2D checkboxTexture = ((RecipeBrowser)ModLoader.GetMod("RecipeBrowser")).GetTexture("UI/checkBox");//UIView.GetEmbeddedTexture("Images/UIKit/checkBox");
        static Texture2D checkmarkTexture = ((RecipeBrowser)ModLoader.GetMod("RecipeBrowser")).GetTexture("UI/checkMark");//UIView.GetEmbeddedTexture("Images/UIKit/checkMark");
